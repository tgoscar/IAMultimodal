...
el Cuaderno A, celda 2 (`encode_images`/`encode_texts`) (embeddings), Cuaderno A, celda `# 3. CELDA CLAVE` (`recall_at_k`), Cuaderno A §5 (`mine_hard_negatives` propia), Cuaderno B, celda `# 3. CELDA CLAVE` + matriz de confusión, Cuaderno B §4 (`checkpoint_comparison.csv`).
